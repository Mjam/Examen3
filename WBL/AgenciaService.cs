...
namespace WBL
{
    ...
    public class AgenciaService : IAgenciaService
    {
        ...
        public async Task<IEnumerable<AgenciaEntity>> Get()
        {
            try
            {
                var result = sql.QueryAsync<AgenciaEntity,
                   ...
                   >("dbo.AgenciaObtener", "IdCatalogoProvincia,IdCatalogoCanton,IdCatalogoDistrito");
        ...
        public async Task<AgenciaEntity> GetById(AgenciaEntity entity)
        {
            try
            {
                var result = sql.QueryFirstAsync<AgenciaEntity>("dbo.AgenciaObtener", new
                {
                    entity.AgenciaId
                });
        ...
        public async Task<DBEntity> Create(AgenciaEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("dbo.AgenciaInsertar", new
                {
                    entity.Nombre,
        ...
        public async Task<DBEntity> Update(AgenciaEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("dbo.AgenciaActualizar", new
                {
                    entity.AgenciaId,
                    entity.Nombre,
                    entity.IdCatalogoProvincia,
        ...
        public async Task<DBEntity> Delete(AgenciaEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("dbo.AgenciaEliminar", new
                {
                    entity.AgenciaId,
                });
        ...
        public async Task<IEnumerable<AgenciaEntity>> GetLista()
        {
            try
            {
                var result = sql.QueryAsync<AgenciaEntity>("dbo.AgenciaLista");
